...
# Based off 
# 
# https://github.com/ansible/ansible/blob/v2.4.1.0-1/lib/ansible/plugins/action/template.py
# 
# Which bears the notice:
# 
...
class ActionModule(ActionBase):
    ...
    # Not called in this file, integrates with ActionBase, which is at
    # 
    # https://github.com/ansible/ansible/blob/v2.4.1.0-1/lib/ansible/plugins/action/__init__.py
    # 
    # Guessing it has something to do with transfering files to remote hosts?
    # Going to gloss over it for now.
    #  
    ...
    # The only other method in the file, so it's got to accomplish all the 
    # stuff specific to templating.
    # 
    def run(self, tmp=None, task_vars=None):
        ...
        # Process the task arguments, casting values and setting defaults.
        # 
        # Documentation for them can be found at:
        # 
        # http://docs.ansible.com/ansible/2.4/template_module.html
        # 
        ...
        # Seems to just be present to check that it's `None`... I guess 
        # it's some sort of default arg for all actions or something? Or maybe
        # it's just so common that they want to catch it's accidental misuse?
