...
# A {QB::Option} that is for a {QB::Role} option, as derived from the 
# role's {file:doc/qb_roles/metadata.md QB metadata}.
# 
class Option < QB::Options::Option
  ...
  def initialize role, meta, include_path
    ...
    super cli_name: cli_name, value: nil, type: init_type
